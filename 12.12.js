	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function handleDownloadClick(e) {
	            if (e.key == '1') {
	                window.location.href = _config.REQUESTURL + "/control-web/keyUnit/人脸名单.xlsx/downloadTemplate";
	            } else if (e.key == '2') {
	                window.location.href = _config.REQUESTURL + "/control-web/keyUnit/车辆名单.xlsx/downloadTemplate";
	            } else if (e.key == '3') {
	                window.location.href = _config.REQUESTURL + "/control-web/keyUnit/mac地址名单.xlsx/downloadTemplate";
	            } else if (e.key == '4') {
	                window.location.href = _config.REQUESTURL + "/control-web/keyUnit/rfid名单.xlsx/downloadTemplate";
	            }
	        }
