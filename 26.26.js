...
/***/ (function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	    ...
	    function App(props) {
	        ...
	        _this.state = {
	            contentHeight: props.browser.height - 50,
	            mapUrl: props.user.interfaceInfo.metis && props.user.interfaceInfo.metis.alarmConfig,
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            if (browser.width !== _browser.width || browser.height !== _browser.height) {
	                this.setState({
	                    contentHeight: browser.height - 50
	                });
	            }
	            ...
	            if (JSON.stringify(nextProps.user.interfaceInfo) !== "{}" && JSON.stringify(nextProps.user.interfaceInfo) !== JSON.stringify(this.state.interfaceInfo)) {
	                this.setState({
	                    mapUrl: nextProps.user.interfaceInfo.metis.alarmConfig
	                });
	            }
	        }
	    }, {
	        ...
	        value: function dealAlarmMessage(e) {
	            ...
	            if (typeof data === "string") {
	                ...
	                console.log(obj);
	                if (obj["function"] === 'showPermisConfig') {
	                    var titles = this.state.titles;
	
	                    titles.head = obj.param.name + '\u6743\u9650\u914D\u7F6E';
	                    this.setState({
	                        titles: titles
	                    });
	                    this.indexCode = obj.param.nodeIndexCode;
	                    this.queryKeyUnitAuthUser().then(function (data) {
	                        _this2.setState({
	                            selected: data || []
	                        });
	                        _this2.changeAddDataModalVisible(true);
	                    });
	                }
	            }
	        }
	    }, {
	        key: 'queryKeyUnitAuthUser',
	        value: function queryKeyUnitAuthUser() {
	            return _index4["default"].post('/control-web/keyUnit/queryKeyUnitAuthUser', {
	                ...
	                return _index4["default"].showError(e);
	            });
	        }
	    }, {
	        key: 'dataChange',
	        value: function dataChange(arr) {
	            ...
	            this.saveKeyUnitAndUser(arr);
	        }
	    }, {
	        key: 'saveKeyUnitAndUser',
	        value: function saveKeyUnitAndUser(arr) {
	            var _this3 = this;
	
	            _index4["default"].post('/control-web/keyUnit/saveKeyUnitAndUser', {
	                "indexCode": this.indexCode,
	                "userInfo": arr.map(function (item) {
	                    return {
	                        userId: item.key,
	                        userName: item.name
	                    };
	                ...
	                _this3.changeAddDataModalVisible(false);
	            })["catch"](function (e) {
	                return _index4["default"].showError(e);
	            });;
	        }
