	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function getServerData() {
	            ...
	            _http2["default"].post('/control-web/picServer/findAll', {}).then(function (_ref) {
	                var data = _ref.data;
	        ...
	        value: function _delete(ids) {
	            ...
	            _http2["default"].post('/control-web/picServer/delete', {
	                ids: ids.join(',')
	            }).then(function () {
	        ...
	        value: function handleOk() {
	            ...
	            this.props.form.validateFields(function (errors, values) {
	                ...
	                console.log('Submit!!!');
	                console.log(values);
	                _http2["default"].post('/control-web/picServer/savePicServer', values).then(function () {
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(_input2["default"], _extends({ style: { width: 280 }, placeholder: '\u8BF7\u8F93\u5165\u56FE\u7247\u670D\u52A1\u5668\u540D\u79F0' }, getFieldProps('name', {
	                                    rules: [_dic.RULE_REQUIRED, _dic.RULE_LT64LETTERS]
	                                })))
	                            ),
	                            _react2["default"].createElement(
	                                FormItem,
	                                ...
	                                _react2["default"].createElement(_input2["default"], _extends({ style: { width: 280 }, placeholder: '\u8BF7\u8F93\u5165\u56FE\u7247\u670D\u52A1\u5668id' }, getFieldProps('id', {
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(_input2["default"], _extends({ style: { width: 280 }, placeholder: '\u8BF7\u8F93\u5165\u56FE\u7247\u670D\u52A1\u5668ip' }, getFieldProps('ip', {
	                                    rules: [_dic.RULE_REQUIRED, _dic.RULE_INCORRECTIP]
	                                })))
	                            ),
	                            _react2["default"].createElement(
	                                FormItem,
	                                ...
	                                _react2["default"].createElement(_input2["default"], _extends({ style: { width: 280 }, placeholder: '\u8BF7\u8F93\u5165\u56FE\u7247\u670D\u52A1\u5668\u7AEF\u53E3' }, getFieldProps('port', {
	                                    rules: [_dic.RULE_REQUIRED, _dic.RULE_INCORRECTPORT]
	                                })))
	                            )
	                        )
	                    )
